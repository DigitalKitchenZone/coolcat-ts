...
export function actionFromJSON(object: any): Action {
  switch (object) {
    ...
    case "ActionCreateProfile":
      return Action.ActionCreateProfile;

    case 3:
    case "ActionUseClowder":
      return Action.ActionUseClowder;
...
export function actionToJSON(object: Action): string {
  switch (object) {
    ...
    case Action.ActionCreateProfile:
      return "ActionCreateProfile";

    case Action.ActionUseClowder:
      return "ActionUseClowder";
